        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm opacity-90 leading-relaxed max-w-md">
              {getContent(content, 'footer_brand_description', 'Delivering authentic, pure, and natural ayurvedic powders crafted from traditional wisdom. Experience the power of nature with every product.')}
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/data-deletion" className="text-sm opacity-80 hover:opacity-100 transition-opacity">Data Deletion</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                ...
                <a href={`tel:${getContent(content, 'footer_phone', '+918758808684')}`} className="text-sm opacity-80 hover:opacity-100 transition-opacity">
                  {getContent(content, 'footer_phone', '+91 8758808684')}
                </a>
              </li>
              <li className="flex items-center gap-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm opacity-80">{getContent(content, 'footer_address', 'Ecovia Enterprises\nIndia')}</span>
              </li>
            </ul>
            ...
            <div className="flex gap-4 mt-6">
              <a
                ...
                className="w-14 h-14 bg-primary-foreground/10 rounded-full flex items-center justify-center hover:bg-primary-foreground/20 transition-colors"
