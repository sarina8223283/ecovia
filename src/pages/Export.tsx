...
const exportCredentials = [
  { icon: FlaskConical, title: 'NABL Tested', description: 'Products tested at NABL-approved laboratories' },
  { icon: Shield, title: 'Quality Certified', description: 'Quality certificates available on request' },
  { icon: Award, title: 'Premium Grade', description: 'Export-quality premium herbal products' },
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              We have tested products with <strong className="text-foreground">NABL-approved labs</strong> which 
              you can request anytime. We promise quality based on quality testing. All certificates 
              and test reports are available on request for your import documentation needs.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="grid grid-cols-2 gap-4">
                {products.slice(0, 4).map((product, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: index * 0.1 }}
                    className="aspect-square rounded-xl overflow-hidden shadow-card relative"
                  >
                    <img 
                      src={product.image} 
                      alt={product.name}
