...
import { MapPin, Users, TrendingUp, Building2, BarChart3, Globe2, Share2 } from 'lucide-react';
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content="Explore Mittika's presence across India. State-wise distribution, visitor analytics, and social media insights for our natural herbal products." />
      </Helmet>
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-b from-primary/5 to-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Real-time website analytics and our state-wise distribution across India.
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            >
              ...
              {loading ? (
                ...
                <p className="text-muted-foreground text-sm">No data yet. Views will appear as visitors browse the site.</p>
              ) : (
